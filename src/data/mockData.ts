...
export const owner = {
  ...
  bioParagraph2: `With deep roots in the Rio Grande Valley, Raul's builds are known for their premium Italian finish selections — sourced through his partnership with Royal Decor Gallery — and architectural detailing that rivals anything in Houston or San Antonio at a fraction of the cost.`,
  partner: {
  ...
  principles: [
    {
      ...
      desc: "Every home starts with your vision. We collaborate with architects and source premium Italian finishes through our Royal Decor Gallery partnership.",
    },
    {
      title: "Clear, Transparent Process",
      desc: "From financing to final walkthrough, you're never in the dark. Clear timelines and honest communication at every stage.",
    },
    {
      title: "Local RGV Expertise",
      desc: "We know the Rio Grande Valley — its soil, codes, climate, and neighborhoods. That local expertise directly protects your investment.",
    },
    {
      title: "Integrated Build & Sell",
      desc: "As a licensed Texas real estate agent and builder, Raul manages both the construction and the sale — one trusted professional, no handoffs.",
    },
  ],
  stats: [
...
export const testimonials = [
  {
    id: "1",
    name: "Maria & Jonathan L.",
    location: "McAllen, TX",
    avatar: images.avatarMaria,
    quote: "We couldn't have asked for a better team to build our forever home.",
    body: "From the very first meeting, the team at RCG Estates made us feel like family. They took time to really listen to what we wanted, asked questions we hadn't even thought of, and helped guide us through every step — from choosing a lot to final finishes.",
    rating: 5,
  },
  {
    id: "2",
    ...
    quote: "RCG Estates made the entire process so smooth — from vision to reality.",
    body: "As a first-time home builder, I was overwhelmed by how much I didn't know. But RCG Estates made it simple. They helped me get pre-approved with a reliable lender, then walked me through lot selection and design. I couldn't be happier with the result.",
    rating: 5,
  },
  {
    id: "3",
    ...
    avatar: images.avatarSandra,
    quote: "Professional, honest, and focused on getting things done right.",
    body: "What stood out to me most was how involved they were at every step. I never felt rushed, and they answered all my questions in detail. You can tell they truly care about what they build — and who they build for.",
    rating: 5,
  },
];
...
export const services: Service[] = [
  {
    ...
    details: [
      ...
      "Collaborative design with award-winning architect",
