...
const FALLBACK: GoogleReview[] = [
  ...
  { author_name: "Kenneth Magallon", profile_photo_url: "", rating: 5, relative_time_description: "2 years ago", text: "Raul has been of great help in knowing more about real estate investing. He helped me get into my first multifamily. Looking forward to close more deals with him in the future." },
  { author_name: "Marco Gonzalez", profile_photo_url: "", rating: 5, relative_time_description: "2 years ago", text: "Raul made property investing a breeze with their expertise and personalized guidance. Highly recommend for anyone looking to invest confidently!" },
  ...
  { author_name: "Chanel Jimenez", profile_photo_url: "", rating: 5, relative_time_description: "11 months ago", text: "Trustworthy and transparent." },
  { author_name: "Rolando Luna", profile_photo_url: "", rating: 5, relative_time_description: "2 years ago", text: "Raul helped me get into the perfect apartment for me. He helped me get my pet in for free and lower my deposit price." },
  { author_name: "Abel Rodriguez", profile_photo_url: "", rating: 5, relative_time_description: "2 years ago", text: "Was super helpful and friendly. I came to Raul and he helped rent out my apartment in Edinburg, made my life so much easier." },
];
...
export default function ReviewsMarquee() {
  ...
  const [meta, setMeta] = useState<ReviewsMeta>({ rating: 5.0, total: 12 });
    ...
    fetch("/api/reviews")
      ...
      .then((data) => {
        if (Array.isArray(data.reviews) && data.reviews.length > 0) {
          // Merge: put live reviews first, append any fallback names not in live set
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-1.5 bg-white border border-neutral-200 shadow-sm rounded-full">
                  ...
                  <span className="text-xs font-bold text-[#111827]">{meta.rating.toFixed(1)}</span>
                  <span className="text-xs text-gray-400">· {meta.total} reviews</span>
                </div>
              </div>
            </div>
            <a
