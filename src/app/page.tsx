...
const MARQUEE_ITEMS = [
  { name: "Amaris Ramirez", location: "Rio Grande Valley, TX", rating: 5, quote: "It can be scary to start the process of building a home when you don't know where to begin, but RCG made it seamless! They were very helpful throughout the entire process, from start to finish. Def recommend!" },
  { name: "Valeria Cantu", location: "Rio Grande Valley, TX", rating: 5, quote: "Working with RCG Estates and Construction to build my home was one of the best decisions I've made. Their team was professional, communicative, and fully committed to turning my vision into reality." },
  { name: "Marcelo Flores", location: "Rio Grande Valley, TX", rating: 5, quote: "Raul Ceron is an extraordinary individual who exemplifies excellence in every endeavor. Whether building and selling impressive properties or overseeing construction, Raul does it all with unmatched dedication." },
  { name: "Kenneth Magallon", location: "Rio Grande Valley, TX", rating: 5, quote: "Raul has been of great help in knowing more about real estate investing. He helped me get into my first multifamily. Looking forward to close more deals with him in the future." },
  { name: "Marco Gonzalez", location: "Rio Grande Valley, TX", rating: 5, quote: "Raul made property investing a breeze with their expertise and personalized guidance. Highly recommend for anyone looking to invest confidently!" },
  { name: "Noah Villarreal", location: "Rio Grande Valley, TX", rating: 5, quote: "Closes deals and gets business done, best realtor for construction & development!!" },
  { name: "Chanel Jimenez", location: "Rio Grande Valley, TX", rating: 5, quote: "Trustworthy and transparent." },
  { name: "Rolando Luna", location: "Edinburg, TX", rating: 5, quote: "Raul helped me get into the perfect apartment for me. He helped me get my pet in for free and lower my deposit price." },
  { name: "Abel Rodriguez", location: "Edinburg, TX", rating: 5, quote: "Was super helpful and friendly. I came to Raul and he helped rent out my apartment in Edinburg, made my life so much easier." },
];
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-1.5 bg-white border border-neutral-200 shadow-sm rounded-full">
                  {/* Google G */}
                  ...
                  <span className="text-xs font-bold text-[#111827]">5.0</span>
